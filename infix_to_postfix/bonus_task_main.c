...
// ÅðéóôñÝöåé ôï åðßðåäï ðñïôåñáéüôçôáò åíüò ôåëåóôÞ
...
// ÅëÝã÷åé áí Ýíáò ÷áñáêôÞñáò åßíáé ôåëåóôÞò
int is_operator(char c) {
    return c=='+' || c=='-' || c=='*' || c=='/' || c=='^' || c=='%';
}

// ÌåôáôñÝðåé ìéá ìáèçìáôéêÞ ðáñÜóôáóç áðü åíäïèåìáôéêÞ óå ìåôáèåìáôéêç
